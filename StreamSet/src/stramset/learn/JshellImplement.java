...
public class JshellImplement {
	public static void main(String[] args) {
		IntStream.range(0, 10);
		IntStream.range(0, 10).sum();
		IntStream.rangeClosed(0, 10).sum();

		System.out.println(IntStream.iterate(1, f -> f + 2).limit(10).sum());
		System.out.println(IntStream.iterate(1, f -> f + 2).limit(10).peek(System.out::println).sum());
		System.out.println(IntStream.iterate(2, f -> f + 2).limit(10).peek(System.out::println).sum());
		System.out.println(IntStream.iterate(2, f -> f * 2).limit(10).peek(System.out::println).sum());
		System.out.println(IntStream.iterate(2, f -> f * 2).limit(10).boxed().collect(Collectors.toList()));
